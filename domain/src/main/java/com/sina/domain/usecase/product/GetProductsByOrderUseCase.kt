...
class GetProductsByOrderUseCase@Inject constructor(private val productsRepository: ProductsRepository) :
    UseCaseFlow<GetProductsByOrderUseCase.Params, List<Products>>() {
